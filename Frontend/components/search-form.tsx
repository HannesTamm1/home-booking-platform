...
export function SearchForm({
  ...
  return (
    <form action="/" method="get" className="mt-6 flex flex-col gap-3">
      <div className="grid gap-3 lg:grid-cols-[1.2fr_1fr_1fr_0.8fr_auto]">
        ...
        <div className="relative">
          <input
            ...
            className="h-12 w-full rounded-full border border-neutral-300 bg-white px-4 text-sm text-neutral-900 outline-none transition focus:border-neutral-900"
          />
        </div>
      ...
      {nights > 0 && (
        <div className="flex items-center justify-center gap-2 rounded-full bg-blue-500 px-5 py-2 text-sm font-medium text-white shadow-sm lg:col-span-2 lg:col-start-2 lg:self-start">
          <svg
