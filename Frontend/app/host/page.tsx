  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-8 sm:px-6">
      <div className="mb-8">
        ...
        <p className="mt-1 text-sm text-neutral-500">Here's what's happening with your listings.</p>
      </div>
        ...
        <div>
          ...
          {data?.upcomingBookings.length === 0 || !data ? (
            <div className="rounded-[2rem] border border-dashed border-neutral-300 bg-white p-8 text-center">
              <p className="text-sm text-neutral-500">No upcoming stays.</p>
            ...
            <div className="space-y-3">
              {data.upcomingBookings.map((booking) => (
                <div key={booking.id} className="flex items-center gap-4 rounded-2xl border border-neutral-200 bg-white p-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="truncate font-medium text-neutral-900">{booking.listingTitle}</p>
        ...
        <div>
          ...
          <div className="space-y-3">
            <Link
              ...
              className="flex items-center gap-3 rounded-2xl border border-neutral-200 bg-white p-4 transition hover:border-rose-300 hover:bg-rose-50"
            >
              <span className="text-xl">➕</span>
              <div>
                <p className="text-sm font-semibold text-neutral-900">New listing</p>
                <p className="text-xs text-neutral-500">Add a property to start hosting</p>
              </div>
            </Link>
            <Link
              href="/host/listings"
              className="flex items-center gap-3 rounded-2xl border border-neutral-200 bg-white p-4 transition hover:border-neutral-400"
            >
              <span className="text-xl">🏠</span>
              <div>
                <p className="text-sm font-semibold text-neutral-900">My listings</p>
                <p className="text-xs text-neutral-500">
            ...
            >
              <span className="text-xl">📋</span>
              <div>
                <p className="text-sm font-semibold text-neutral-900">All reservations</p>
